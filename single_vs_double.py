# -*- coding: utf-8 -*-
"""
Code to compare the single and double gaussian fits to the Y(1S) peak.
...
# Produce all plots
plt.title("Gaussian plus exponential fitting of first peak invariant mass data")
plt.xlabel("Invariant mass of muon pairs (GeV/c^2)")
plt.ylabel("PDF")
plt.bar(xdata, ydata, width=binwidth, color='blue', label='Histogram')
plt.plot(xdata, fit(xdata, *popt1), color='green', label='Double Gaussian')
plt.plot(xdata, fit2(xdata, *popt2), color='red', label='Single Gaussian')
